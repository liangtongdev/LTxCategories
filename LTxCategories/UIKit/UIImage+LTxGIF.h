...
@interface UIImage (LTxGIF)

/*
 UIImage *animation = [UIImage ltx_animatedImageWithAnimatedGIFData:theData];
 ...
 */
+ (UIImage *)ltx_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
 UIImage *image = [UIImageltx_ animatedImageWithAnimatedGIFURL:theURL];
 ...
 */
+ (UIImage *)ltx_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
@end
